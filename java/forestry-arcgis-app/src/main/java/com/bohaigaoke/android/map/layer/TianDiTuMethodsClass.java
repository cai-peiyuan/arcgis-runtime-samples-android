package com.bohaigaoke.android.map.layer;
...
public class TianDiTuMethodsClass {
    private static final List<String> SubDomain = Arrays.asList(new String[]{"t0", "t1", "t2", "t3", "t4", "t5", "t6"});
    ...
    public static WebTiledLayer CreateTianDiTuTiledLayer(LayerType layerType) {
        ...
        try {
            ...
            //Arcgis100.4 默认添加了请求referer 值,天地图会拒绝请求,替换为http://map.tianditu.gov.cn/ 可正常显示.(arcgis 降级到100.1也可正常显示)
